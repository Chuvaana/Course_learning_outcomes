...
export class FinalExamService {
  ...
  getAllFinalExamQuestions(lessonId: string){
    return this.http.get(`${this.apiUrl1}/finalExamQuestion/${lessonId}`);
  }
  ...
  deleteFinalExam(id : any){
    return this.http.delete(`${this.apiUrl1}/finalExamQuestion/${id}`);
  }
