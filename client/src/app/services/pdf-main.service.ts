      ...
      content: [
        ...
        },
        {
          table: {
            widths: ['*', 'auto'],
            body: [
              [{ text: '1. ХИЧЭЭЛИЙН СУРАЛЦАХУЙН ҮР ДҮНГ ҮНЭЛЭХ ЕРӨНХИЙ ЗАРЧИМ', fontSize: 10, bold: true }, { text: '' }],
              [{ text: '2. ХИЧЭЭЛИЙН ЕРӨНХИЙ МЭДЭЭЛЭЛ', fontSize: 10, bold: true }, { text: '' }],
              [{ text: '3. ХИЧЭЭЛЭЭР ЭЗЭМШИХ СУРАЛЦАХУЙН ҮР ДҮНГҮҮД', fontSize: 10, bold: true }, { text: '' }],
              [{ text: '4. ХИЧЭЭЛИЙН СУРАЛЦАХУЙН ҮР ДҮНГҮҮДИЙН ҮНЭЛГЭЭНИЙ ТӨЛӨВЛӨЛТ', fontSize: 10, bold: true }, { text: '' }],
              [{ text: '5. ХИЧЭЭЛИЙН ШУУД БА ШУУД БУС ҮНЭЛГЭЭНИЙ ҮР ДҮН', fontSize: 10, bold: true }, { text: '' }],
              [{ text: '   5.1. ХИЧЭЭЛИЙН СУРАЛЦАХУЙН ҮР ДҮНГИЙН ШУУД ҮНЭЛГЭЭНИЙ ГҮЙЦЭТГЭЛ', fontSize: 10 }, { text: '' }],
              [{ text: '      5.1.1. ТУХАЙН CLO-Д ХАРГАЛЗАХ ОЮУТНЫ ГҮЙЦЭТГЭЛИЙН ҮНЭЛГЭЭ', fontSize: 10 }, { text: '' }],
              [{ text: '      5.1.2. ХИЧЭЭЛИЙН СУРАЛЦАХУЙН ҮР ДҮНГИЙН ҮНЭЛГЭЭНИЙ НЭГДСЭН ҮЗҮҮЛЭЛТ', fontSize: 10 }, { text: '' }],
              [{ text: '   5.2. ХИЧЭЭЛИЙН СУРАЛЦАХУЙН ҮР ДҮНГИЙН ШУУД БУС ҮНЭЛГЭЭНИЙ ГҮЙЦЭТГЭЛ', fontSize: 10 }, { text: '' }],
              [{ text: '      5.2.1. ХИЧЭЭЛИЙН СУРАЛЦАХУЙН ҮР ДҮНГИЙН САНАЛ АСУУЛГЫН ДҮН', fontSize: 10 }, { text: '' }],
              [{ text: '      5.2.2. CLOs-ИЙН САНАЛ АСУУЛГЫН ҮР ДҮНГИЙН ГРАФИК ҮЗҮҮЛЭЛТ', fontSize: 10 }, { text: '' }],
              [{ text: '   5.3. ШУУД БА ШУУД БУС ҮНЭЛГЭЭНИЙ НЭГДСЭН ҮЗҮҮЛЭЛТ', fontSize: 10 }, { text: '' }],
              [{ text: '6. САНАЛ АСУУЛГЫН БУСАД ҮР ДҮНГҮҮДЭД ХИЙСЭН ДҮН ШИНЖИЛГЭЭ', fontSize: 10, bold: true }, { text: '' }],
              [{ text: '7. СУРАЛЦАХУЙН ҮР ДҮНГИЙН ГҮЙЦЭТГЭЛИЙГ САЙЖРУУЛАХ ТӨЛӨВЛӨЛТ', fontSize: 10, bold: true }, { text: '' }],
              [{ text: '   7.1. ХИЧЭЭЛИЙН ОНЦЛОГ, ДАВУУ ТАЛУУД', fontSize: 10 }, { text: '' }],
              [{ text: '   7.2. ХИЧЭЭЛИЙН СУЛ ТАЛУУД', fontSize: 10 }, { text: '' }],
              [{ text: '   7.3. СУРАЛЦАХУЙН ҮР ДҮНГИЙН ГҮЙЦЭТГЭЛИЙГ ДЭЭШЛҮҮЛЭХ ЧИГЛЭЛЭЭР ХИЙХ АЖЛЫН ТӨЛӨВЛӨЛТ', fontSize: 10 }, { text: '' }],
              [{ text: '8. ХАВСРАЛТ 1. ХИЧЭЭЛИЙН САНАЛ АСУУЛГЫН ЗАГВАР', fontSize: 10, bold: true }, { text: '' }],
            ],
          },
          layout: {
            hLineWidth: () => 0,
        ...
        },
        {
          ol: [
            ...
            {
              ul: [
                { text: '91-100%: Шаардлага бүрэн хангаж;', bold: true },
                { text: '81-90%: Шаардлага хангасан, зарим талаар сайжруулалт хийж болно;', bold: true },
                { text: '70-80%: Шаардлага хангасан, гэхдээ сайжруулалт хийх хэрэгтэй;', bold: true },
                { text: '70%-аас доош: Шаардлага хангаагүй, заавал сайжруулалт хийх шаардлагатай.', bold: true },
              ],
              margin: [20, 5, 0, 5]
            }, {
              text: [
            ...
            },
            {
              ul: [
                { text: '91-100%: Шаардлага бүрэн хангаж;', bold: true },
                { text: '81-90%: Шаардлага хангасан, зарим талаар сайжруулалт', bold: true },
                { text: '70-80%: Шаардлага хангасан, гэхдээ сайжруулалт хийх хэрэгтэй;', bold: true },
                { text: '70%-аас доош: Шаардлага хангаагүй, заавал сайжруулалт хийх шаардлагатай.', bold: true },
              ],
              margin: [20, 5, 0, 0]
