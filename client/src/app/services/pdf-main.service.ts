        ...
        { text: 'Агуулга', style: 'headerTitle', margin: [0, 50, 0, 10] as [number, number, number, number] },
        {
          table: {
            ...
            body: [
              ...
              [{ text: '3. ХИЧЭЭЛЭЭР ЭЗЭМШИХ СУРАЛЦАХУЙН ҮР ДҮНГҮҮД', fontSize: 10, bold: true }, { text: '5' }],
              [{ text: '4. ХИЧЭЭЛИЙН СУРАЛЦАХУЙН ҮР ДҮНГҮҮДИЙН ҮНЭЛГЭЭНИЙ ТӨЛӨВЛӨЛТ', fontSize: 10, bold: true }, { text: '6' }],
              [{ text: '5. ХИЧЭЭЛИЙН ШУУД БА ШУУД БУС ҮНЭЛГЭЭНИЙ ҮР ДҮН', fontSize: 10, bold: true }, { text: '7' }],
